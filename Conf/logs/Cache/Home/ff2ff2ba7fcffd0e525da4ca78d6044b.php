...
<head>
  ...
  <title>渠道代理_<?php echo ($f_siteName); ?>_微信营销推广行业领导品牌</title>
  <meta name="keywords"  content="<?php echo ($f_siteName); ?>、微信营销代理、微信推广代理、微信代理、微信运营代理"/>
	...
	<div class="wrap">
		...
		<div class="header-nav">
			<ul>
				...
				<li>
					<a href="<?php echo U('Home/Index/spread');?>" class="active">渠道代理</a>
				</li>
