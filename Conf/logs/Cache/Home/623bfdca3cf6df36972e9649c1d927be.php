...
<head>
  ...
  <title>功能导航_<?php echo C('site_name');?>_微信营销推广行业领导品牌</title>
  <meta name="keywords"  content="微官网、微客服、微会员、微商圈、微电商、微营销、微支付、微推广"/>
  <meta name="description"  content="全面的功能导航：微官网、微会员、微客服、微推广、微团购、微投票、微统计、微门店、微活动、微报名、微行业、微定制"/>
	...
	<div class="wrap">
		...
		<div class="header-nav">
			<ul>
				...
				<li>
					<a href="<?php echo U('Home/Index/navigation');?>" class="active">功能导航</a>
				</li>
				<li>
...
<div class="body">
  <div class="clearfix article">
    <div class="article-top">
      <div class="wrap">
        <div class="edit-box">
          <h4>微官网——快速建立企业微信官网，全方位展现企业品牌</h4>
          <small>5分钟快速搭建微网站，更多功能随意组合，选择更丰富，变换更随心； 作为业内首家网站流量分析的平台，<?php echo C('site_name');?>通过在不同时段内针对PV、UV、IP、跳出率、访问时长等维度进行分析统计，方便快捷监控信息。</small>
          <p class="text-center">
    ...
    <div class="clearfix bg-gray bg-shadow">
      <div class="wrap text-center">
        <img src="<?php echo RES;?>/images/website.png">
      </div>
    </div>
  </div>
</div>
