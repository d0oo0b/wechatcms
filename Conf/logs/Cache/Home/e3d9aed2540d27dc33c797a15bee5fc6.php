...
<head>
  ...
  <title>渠道代理_<?php echo C('site_name');?>_微信营销推广行业领导品牌</title>
  <meta name="keywords"  content="<?php echo C('site_name');?>、微信营销代理、微信推广代理、微信代理、微信运营代理"/>
  <meta name="description"  content="<?php echo C('site_name');?>提供最完备的微信营销行业化解决方案，并提供快速、高效的个性化定制解决方案，全功能账号免费使用。拥有各类丰富的厂商资源、完整的渠道支撑体系，全方位支持服务代理商公司建设，全程关注代理商成长。"/>
...
<div class="body">
  <div class="flash h460 border-1" style="background: url(<?php echo RES;?>/images/img/ad-spread.jpg) no-repeat center 0 #f4f9ff;">
              ...
              <div class="list-comment">
                  <div class="comment-title">
                      <div class="comment-img">
                          <img src="<?php echo RES;?>/images/dong01.jpg">
                      </div>
                      <div class="comment-name">
                          <h5>王先生</h5>
                          <span>苏州八零年代 | 公司董事长</span>
                      </div>
                  </div>
            ...
            <li>
              <div class="list-comment">
                <div class="comment-title">
                  <div class="comment-title">
                      <div class="comment-img">
                          <img src="<?php echo RES;?>/images/dong02.jpg">
                      </div>
                      <div class="comment-name">
                          <h5>张先生</h5>
                          <span>石家庄信威科技有限公司 | 董事长</span>
                      </div>
                  </div>
                  <div class="comment-content"><?php echo C('site_name');?>，微信生意好帮手。1个月40个订单，50个客户，100万的收入。微信营销，我选<?php echo C('site_name');?>。</div>
              </div>
            </li>
            <li>
              <div class="list-comment">
                <div class="comment-title">
                    <div class="comment-img">
                        <img src="<?php echo RES;?>/images/dong03.jpg">
                    </div>
                    <div class="comment-name">
                        <h5>蔡先生</h5>
                        <span>中山市菜鸟信息技术有限公司 | CEO</span>
                    </div>
                </div>
                <div class="comment-content">
                    靠谱比什么都重要，微信生意，我选<?php echo C('site_name');?>，靠谱的第三方服务平台
                </div>
              </div>
            </li>
          </ul>
      ...
      <div class="table">
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>
              <span>整合资源</span>
              <p>提供旗下KTV技术联盟（www.ktvcity.com）平台资源支持（国内微信营销厂商基本无此特色资源），CPC 模式；并提供微客本地化生活服务平台(vcoolife)支持；以及其他营销所需硬件资源整合。 物料支持</p>
              <i></i>
              <em></em>
            </td>
            <td>
  ...
  <div class="clearfix spread spread-3">
    <div class="wrap">
      <h4>联系渠道经理</h4>
      <div class="clearfix">
        <dl class="spread-3-l">
