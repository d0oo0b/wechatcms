                ...
                <table>
                    ...
                    <tr>
                        ...
                        function refreshImg2(){
                        	document.getElementById("txtCheckCode2").src="/index.php?m=Index&a=verifyLogin&s="+Math.random();
                        }
                        </script>
                        <input name="verifycode2" type="text" size="8" style="width:80px;" class="text" maxlength="4" />&nbsp;<img src="<?php echo U('Index/verifyLogin');?>" id="txtCheckCode2"/>&nbsp;<a href="javascript:refreshImg2();" style="color:#666">看不清？换一张</a></td>
                    </tr>
                    <tr>
                        <th>&nbsp;</th>
                        <td>
                ...
                <table>
					...
					<tr>
                     ...
                     <tr>
                        ...
                        <input name="verifycode" type="text" size="4" style="width:80px;" class="text" maxlength="4" />&nbsp;<img src="<?php echo U('Index/verify');?>" id="txtCheckCode"/>&nbsp;<a href="javascript:refreshImg();" style="color:#666">看不清？换一张</a></td>
                    </tr>
                    <tr>
                        <th>&nbsp;</th>
