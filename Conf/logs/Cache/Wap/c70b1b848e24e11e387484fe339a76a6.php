...
<html>
	...
	<title><?php echo ($tpl["wxname"]); ?></title>
		<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/template/home-58.css" media="all" />
		...
		<link href="<?php echo RES;?>/css/1140/cate7_3.css" rel="stylesheet" type="text/css">
    </head>
			...
			new Swipe(document.getElementById('banner_box'), {
				...
				callback: function(){
					...
					lis.removeClass("on").eq(this.index).addClass("on");
								...
								<a href="tel:<?php echo ($homeInfo["dianhua"]); ?>" class="tel"><?php if($homeInfo["dianhua"] != false): echo ($homeInfo["dianhua"]); else: ?>没有留电话<?php endif; ?> <span class="icon-phone">&nbsp;</span></a>
							</div>
							        		
						<ul class="list_ul">
										<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,0,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
							...
							<div class="menubtn">
<div class="menuimg"><img src="<?php echo ($vo["img"]); ?>"></div></div>
							
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
										...
										<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,2,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
							...
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
														...
														<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,4,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
									<span class="<?php echo ($vo["icon"]); ?>"></span>
							...
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
														...
														<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,6,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
									<span class="<?php echo ($vo["icon"]); ?>"></span>
							...
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
														...
														<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,10,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
									<span class="<?php echo ($vo["icon"]); ?>"></span>
							...
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
														...
														<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,12,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
									<span class="<?php echo ($vo["icon"]); ?>"></span>
							...
							<dt style="color:<?php echo ($vo["nameyanse"]); ?>"><?php echo ($vo["name"]); ?></dt>
														...
														<li class="box">	
										<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,14,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
						                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            							<dd>
								<div>
									<span class="<?php echo ($vo["icon"]); ?>"></span>
