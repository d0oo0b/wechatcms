		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td>
					<input type="text" id="title" name="title" value="<?php echo ($impress['title']); ?>" class="input-large px"  data-rule-maxlength="10" maxlength="10">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">请不要超过10个中文印象！</span>
					</td>
				</tr>
				<tr>
					<th width="120">显示顺序：</th>
					<td> <input type="text" id="sort" name="sort" value="<?php echo (($impress['sort'])?($impress['sort']):1); ?>" class="input-mini px"  data-rule-number="true">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">数值越大越靠前</span></td>
				</tr>
				<tr>
					<th width="120">印象数：</th>
					<td> <input type="text" id="comment" name="comment" value="<?php echo ($impress['comment']); ?>" class="input-large px"  data-rule-number="true">
                                        <span class="maroon">*</span></td>
				</tr>
				<tr>
					<th>是否显示：</th>
					<td><label class="radio inline">
                                            <input type="radio" name="is_show" value="1" <?php if($impress['is_show'] == 1): ?>checked="checked"<?php endif; ?>>显示此印象
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="is_show" value="0" <?php if($impress['is_show'] == 0): ?>checked="checked"<?php endif; ?>>不显示此印象
                                        </label></td>
				</tr>
				<th>&nbsp;</th>
				  <?php if($impress['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($impress['id']); ?>" /><?php endif; ?>
