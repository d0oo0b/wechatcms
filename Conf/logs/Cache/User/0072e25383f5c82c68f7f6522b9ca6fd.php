...
<div class="cLineB">
  <h4>添加销售</h4><a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
 <!--tab start-->
      ...
      <form class="form" method="post" action="" id="formID" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                <tr>
                    <th width="120">姓名：</th>
                    <td> <input type="text" name="name" id="name" class="px"  value="<?php echo ($salers['name']); ?>" data-validation-engine="validate[required,minSize[1],maxSize[20]]"
                 ...
                 <tr>
                    ...
                    <td>
                     <p>
                         <img class="thumb_img" id="picture_src" src="<?php echo (($salers['picture'])?($salers['picture']):'tpl/User/default/common/car/car_sell.png'); ?>" style="max-height:100px;">
                         <input type="input" class="px" id="picture" value="<?php echo (($salers['picture'])?($salers['picture']):'tpl/User/default/common/car/car_sell.png'); ?>" name="picture" >

                         <span class="help-inline">
                              <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('picture',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picture')">预览</a>
                              <span class="help-inline">建议尺寸：图片150*150</span>
                         </span>
                     </p>
                    </td>
                </tr>
                <tr>
                    <th width="120">电话：</th>
                    <td>
                         <input type="text" name="mobile" id="mobile" class="px"  value="<?php echo ($salers['mobile']); ?>" />
                         <span class="maroon">*</span>
                         <span class="help-inline">如 0551-01234567</span>
                     </td>
                </tr>
                <tr>
                    <th width="120">显示顺序：</th>
                    <td>  <input type="text" id="sort" name="sort" value="<?php echo (($salers['sort'])?($salers['sort']):1); ?>" class="input-mini px"data-validation-engine="validate[required,custom[integer],min[1]]" data-errormessage-value-missing="必填项"  /><span class="maroon">*</span>
                ...
                <tr>
                    ...
                    <select name="salestype" id="salestype">
                      <option value="1" <?php if($salers['salestype'] == 1): ?>checked="checked"<?php endif; ?>>售前</option>
                      <option value="2" <?php if($salers['salestype'] == 2): ?>checked="checked"<?php endif; ?>>售后</option>
                      <option value="3" <?php if($salers['salestype'] == 3): ?>checked="checked"<?php endif; ?>>售前/售后</option>
                    </select>

                    </td>
                </tr>
                <tr>
                    <th width="120">简要介绍:</th>
                    <td> <textarea name="info"  id="info" style="width:605px;height:120px"  data-rule-maxlength="150" placeholder="可不填"><?php echo (strip_tags(html_entity_decode($salers['info']))); ?></textarea> [最多显示 10 个字]</td>
                </tr>
                  ...
                  <tr>
                    <td>
                    <?php if($salers['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($salers['id']); ?>" /><?php endif; ?>
