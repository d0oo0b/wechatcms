		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					...
					<td> <input type="text" id="name" name="name" value="<?php echo ($housetype['name']); ?>" class="input-large px" data-validation-engine="validate[required,minSize[2]]"
                    data-errormessage-value-missing="必填项目!">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">尽量简单，不要超过20字</span></td>
				</tr>
			   <tr>
					<th>请选择子楼盘：</th>
					<td><select id="son_id" name="son_id" class="input-medium" schoolSet>
                  ...
                  <tr>
                    ...
                    <td>
                        <select id="panorama_id" name="panorama_id" class="input-medium" schoolSet>
                                        ...
                                        <span class="maroon">*</span>
                                        <span class="help-inline">如果没有请留空，或者到 <a href="<?php echo U('Panorama/add',array('token'=>$token));?>" class="btn"><strong><font color='red'>360°全景</strong></font></a>添加</span>
                    </td>
                </tr>

				<tr>
					<th width="120">楼层：</th>
					<td> <input type="text" id="floor_num" name="floor_num" value="<?php echo ($housetype['floor_num']); ?>" class="input-large px" data-validation-engine="validate[required]"
				...
				<tr>
					...
					<td> <input type="text" id="area" name="area" value="<?php echo ($housetype['area']); ?>" class="input-large px" data-validation-engine="validate[required]"
                    data-errormessage-value-missing="必填项!">
                                        <span class="maroon">*</span>
				...
				<tr>
					<th>房屋户型：</th>
					<td>
							 <select id="fang" name="fang" class="input-mini" schoolSet>
                                            <option value="1" <?php if($housetype['fang'] == 1): ?>selected="selected"<?php endif; ?>>1</option>
                                            <option value="2" <?php if($housetype['fang'] == 2): ?>selected="selected"<?php endif; ?>>2</option>
                                            <option value="3" <?php if($housetype['fang'] == 3): ?>selected="selected"<?php endif; ?>>3</option>
                                            <option value="4" <?php if($housetype['fang'] == 4): ?>selected="selected"<?php endif; ?>>4</option>
                                            <option value="5" <?php if($housetype['fang'] == 5): ?>selected="selected"<?php endif; ?>>5</option>
                                            <option value="6" <?php if($housetype['fang'] == 6): ?>selected="selected"<?php endif; ?>>6</option>
                                            <option value="7" <?php if($housetype['fang'] == 7): ?>selected="selected"<?php endif; ?>>7</option>
                                        </select>
                                        房
                                        <select id="ting" name="ting" class="input-mini" schoolSet>
                                            <option value="1" <?php if($housetype['ting'] == 1): ?>selected="selected"<?php endif; ?>>1</option>
                                            <option value="2" <?php if($housetype['ting'] == 2): ?>selected="selected"<?php endif; ?>>2</option>
                                            <option value="3" <?php if($housetype['ting'] == 3): ?>selected="selected"<?php endif; ?>>3</option>
                                            <option value="4" <?php if($housetype['ting'] == 4): ?>selected="selected"<?php endif; ?>>4</option>
                                            <option value="5" <?php if($housetype['ting'] == 5): ?>selected="selected"<?php endif; ?>>5</option>
                                            <option value="6" <?php if($housetype['ting'] == 6): ?>selected="selected"<?php endif; ?>>6</option>
                                        </select>
                                        厅
					</td>
				</tr>
				<tr>
					...
					<td>  <input type="text" id="sort" name="sort" value="<?php echo (($housetype['sort'])?($housetype['sort']):1); ?>" class="input-mini px" schoolSet data-rule-number="true">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">数值越大越靠前</span></td>
				</tr>
				<tr>
					<th width="120">户型介绍：</th>
					<td>  <textarea id="description" name="description" class='input-xxlarge'  placeholder="户型介绍简单明了就好" style="width:400px;;height:125px;border: 1px solid #9B9A9A;" ><?php echo ($housetype['description']); ?></textarea>[可以留空]</td>
				</tr>
				<tr>
					<th width="120">户型图片:</th>
					<td> <div id="upimg_main">
                                        <p>
   <?php if($housetype['type1'] != ''): ?><img class="thumb_img" id="type1_src" src="<?php echo ($housetype['type1']); ?>" style="max-height:100px;"><?php endif; ?>
                                            <input type="input" class="px" id="type1" value="<?php echo ($housetype['type1']); ?>" name="type1" data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">
                                            ...
                                            <span class="help-inline">
                                                 <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('type1',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('type1')">预览</a>
                                                <span class="help-inline">建议尺寸：宽720像素，高400像素</span>
                                            </span>
                                        </p>
                                            <br />
                                        <p>
                                           <?php if($housetype['type2'] != ''): ?><img class="thumb_img" id="type2_src" src="<?php echo ($housetype['type2']); ?>" style="max-height:100px;"><?php endif; ?>
                                            <input type="input" class="px" id="type2" value="<?php echo ($housetype['type2']); ?>" name="type2" data-validation-engine="validate[custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">

                                            <span class="help-inline">
                                                 <a href="###" onclick="upyunPicUpload('type2',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('type2')">预览</a>
                                                <span class="help-inline">建议尺寸：宽720像素，高400像素</span>
                                            </span>
                                        </p>
                                            <br />
                                        <p>
                                        <?php if($housetype['type3'] != ''): ?><img class="thumb_img" id="type3_src" src="<?php echo ($housetype['type3']); ?>" style="max-height:100px;"><?php endif; ?>
                                            <input type="input" class="px" id="type3" value="<?php echo ($housetype['type3']); ?>" name="type3" data-validation-engine="validate[custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">

                                            <span class="help-inline">
                                                 <a href="###" onclick="upyunPicUpload('type3',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('type3')">预览</a>
                                                <span class="help-inline">建议尺寸：宽720像素，高400像素</span>
                                            </span>
                                        </p>
                                                <br />
                                        <p>
                                         <?php if($housetype['type4'] != ''): ?><img class="thumb_img" id="type4_src" src="<?php echo ($housetype['type4']); ?>" style="max-height:100px;"><?php endif; ?>
                                            <input type="input" class="px"  id="type4" value="<?php echo ($housetype['type4']); ?>" name="type4" data-validation-engine="validate[custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写,正确的网址,如: http://www.baidu.com/images/demo.png">

                                            <span class="help-inline">
                                                 <a href="###" onclick="upyunPicUpload('type4',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('type4')">预览</a>
                                                <span class="help-inline">建议尺寸：宽720像素，高400像素</span>
                                            </span>
                                        </p>
