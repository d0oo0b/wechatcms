...
<div class="cLineB">
  <h4>添加点评 </h4><a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  ...
				  <td>
					 <input type="text" id="title" name="title" value="<?php echo ($expert['title']); ?>" class="input-large px" schoolSet data-rule-maxlength="20">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">尽量简单，不要超过20字</span></td>
				</tr>
				<tr>
					<th width="120">显示顺序:</th>
					<td> <input type="text" id="sort" name="sort" value="<?php echo (($expert['sort'])?($expert['sort']):1); ?>" class="input-mini px" schoolSet data-rule-number="true">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">数值越大越靠前</span></td>
				</tr>
				<tr>
					<th width="120">专家姓名：</th>
					<td> <input type="text" id="name" name="name" value="<?php echo ($expert['name']); ?>" class="input-large px" schoolSet>
                                        <span class="maroon">*</span></td>
				</tr>
				<tr>
					<th width="120">专家职位：</th>
					<td>  <input type="text" id="position" name="position" value="<?php echo ($expert['position']); ?>" class="input-large px" schoolSet data-rule-maxlength="20">
                                        <span class="maroon">*</span></td>
				</tr>
				<tr>
					<th width="120">专家照片：</th>
					<td>  <script src="<?php echo STATICS;?>/upyun.js"></script>
                                        <p>
<?php if($expert['face'] != ''): ?><img class="thumb_img" id="face_src" src="<?php echo ($expert['face']); ?>" style="max-height:100px;"><?php endif; ?>
                                            <input type="input" class="px" id="face" value="<?php echo ($expert['face']); ?>" name="face" >

                                            <span class="help-inline">
                                                 <a href="###" onclick="upyunPicUpload('face',720,400,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('face')">预览</a>
				...
				<tr>
					...
					<td>  <textarea id="description" name="description" placeholder='专家描述' style="width:560px;height:175px;border: 1px solid #979292;" ><?php echo ($expert['description']); ?></textarea>
                                        <span class="maroon">*</span>
                                        </td>
				</tr>
				<tr>
					<th>点评内容：</th>
					<td>
	 <textarea id="comment" name="comment" placeholder='点评内容' style="width:560px;height:175px;border: 1px solid #979292;" ><?php echo ($expert['comment']); ?></textarea>
                                        <span class="maroon">*</span>

					</td>
				</tr>
				<th>&nbsp;</th>
				  <?php if($expert['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($expert['id']); ?>" /><?php endif; ?>
