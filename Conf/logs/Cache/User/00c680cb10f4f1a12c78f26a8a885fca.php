            ...
            <tbody>
               ...
               <tr>
                ...
                <tr>
                    ...
                    data-errormessage-value-missing="必填项!"  value="<?php echo ($series['shortname']); ?>"/>
                      <span class="maroon">*</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($series['picture'] != ''): ?><img class="thumb_img" id="picture_src" src="<?php echo ($series['picture']); ?>" style="max-height: 100px;" /><?php endif; ?>
                                        <input type="text" class="px" id="picture" name="picture" value="<?php echo ($series['picture']); ?>" data-validation-engine="validate[required,custom[url]]"
                    data-errormessage-value-missing="必须上传图片!"  data-errormessage-custom-error="如果是手动填写外链,正确的网址,如: http://www.baidu.com/images/demo.png"/>
                                        ...
                                        <span class="help-inline">
                                            <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('picture',640,180,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picture')">预览</a>
                                        </span>
                ...
                <tr>
                    <th>显示顺序：</th>
                    <td>
                    <input type="text" id="sort" name="sort" value="<?php echo (($series['sort'])?($series['sort']):1); ?>" class="px" data-validation-engine="validate[required,custom[integer],min[1]]" data-errormessage-value-missing="必填项" /><span class="maroon">*</span>
