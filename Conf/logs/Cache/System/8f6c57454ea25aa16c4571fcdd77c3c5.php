...
<meta name="keywords" content="<?php echo ($f_siteName); ?>-<?php echo ($f_siteName); ?>后台管理系统" />
<meta name="description" content="<?php echo ($f_siteName); ?>-<?php echo ($f_siteName); ?>后台管理系统" />
  ...
  <tr>
	...
	<div class="top">
    	<a href="/" class="logo" title="首页">首页</a>
		 <div class="login">
			<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用<?php echo ($f_siteName); ?>微信管理平台！</li>	
			<li><a href="/index.php" target="_blank"> 访问首页</a></li>
			<li><a href="/index.php?g=User&m=Index&a=index" target="_blank">用户中心</a></li>
			<li><a href="http://www.466777.com">官方网址</a></li>
			<li><a href="http://www.jihuodi.com">官方论坛</a></li>
...
<p class="fr"> Copyright &copy; 2012-2015 <?php echo ($f_siteName); ?>版权所有  </p>
</div></td>
  </tr>
</table>
</body>
